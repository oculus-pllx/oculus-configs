...
8. **Transition to implementation** — read and follow `~/.gemini/skills/writing-plans/SKILL.md`
...
Read and follow `~/.gemini/skills/writing-plans/SKILL.md` to create the implementation plan.
