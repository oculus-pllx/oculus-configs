...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .icon-btn{background:var(--surface);border:1px solid var(--border);color:var(--text-3);padding:5px 8px;font-size:13px;border-radius:6px;cursor:pointer;backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur);transition:all .15s;font-family:inherit}
    ...
    .card{background:var(--surface);border:1px solid var(--border);border-radius:10px;padding:16px;backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur);transition:border-color .2s,box-shadow .2s}
    ...
    /* ── MCP rows ── */
    .mcp-row{background:var(--surface);border:1px solid var(--border);border-radius:10px;padding:16px 18px;margin-bottom:10px;display:flex;justify-content:space-between;align-items:flex-start;gap:16px;backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur)}
    .mcp-row .inf{flex:1}
    ...
    .tab{padding:6px 14px;background:var(--surface);border:1px solid var(--border);border-radius:20px;cursor:pointer;font-size:12px;color:var(--text-3);transition:all .15s;backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur)}
    ...
    .info-box{background:var(--surface);border:1px solid var(--border);border-radius:8px;padding:14px 16px;margin-bottom:20px;font-size:12px;color:var(--text-3);line-height:1.6;backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur)}
